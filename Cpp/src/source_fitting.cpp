...
{ std::printf(" LXTRPM: stub — translate from source.f L25149-25192\n"); return 0.0; }
...
{ ISIG = 0; BARA = 0; B = 0; BARL = 0; BARC = 1; FLCRIT = 0; AVAL = 0; WID = 1; CHISQ = 0;
  std::printf(" LXTRP1: stub — translate from source.f L25194-25554\n"); }
...
{ SIZE = 0; std::printf(" LXTRP2: stub — translate from source.f L25556-25594\n"); }
